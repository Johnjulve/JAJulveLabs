...
export const TopTicker: React.FC = () => {
  return (
    <div className="w-full bg-[#05101a] border-b border-sky-950/60 text-slate-300 text-xs py-1.5 sm:py-2 px-3 sm:px-8 flex items-center justify-between gap-3 z-50">
